...
public class Utils {
	...
	public static int boxSize = Integer.parseInt(Utils.bundle.getString("boxSize"));
	...
	static public int[] modulo(int x, int y){
		int res[] = new int[2];
		int grideSizeX = Integer.parseInt(bundle.getString("gridSizeX"));
		int grideSizeY = Integer.parseInt(bundle.getString("gridSizeY"));
